...
%% API
createMonitor_test() -> [] =
  dict:fetch_keys(pollution:createMonitor()).
addStation1_test() -> [{station, "Qwerty", {12, 34}}] =
  dict:fetch_keys(pollution:addStation("Qwerty", {12, 34},
    pollution:createMonitor())).
addStation2_test() -> already_exists =
  pollution:addStation("Qwerty", {34,12},
    pollution:addStation("Qwerty", {12, 34},
      pollution:createMonitor())).
addStation3_test() -> already_exists =
  pollution:addStation("Qwert", {12,34},
    pollution:addStation("Qwerty", {12, 34},
      pollution:createMonitor())).
addStation4_test() -> [{station, "Qwerty", {12, 34}}, {station, "Asdf", {56,78}}] =
  dict:fetch_keys(pollution:addStation("Asdf", {56,78},
    pollution:addStation("Qwerty", {12, 34},
      pollution:createMonitor()))).
addValue1_test() -> [{measurement, {{2018,4,1},{0,0,0}}, temp, 10}] =
  dict:fetch({station, "Qwerty", {12, 34}},
    pollution:addValue("Qwerty", {{2018,4,1}, {0,0,0}}, temp, 10,
      pollution:addStation("Qwerty", {12, 34},
        pollution:createMonitor()))).
addValue2_test() -> [{measurement, {{2018,4,1},{0,0,0}}, temp, 10}] =
  dict:fetch({station, "Qwerty", {12, 34}},
    pollution:addValue({12, 34}, {{2018,4,1}, {0,0,0}}, temp, 10,
      pollution:addStation("Qwerty", {12, 34},
        pollution:createMonitor()))).
addValue3_test() -> already_exists =
  pollution:addValue("Qwerty", {{2018,4,1}, {0,0,0}}, temp, 20,
      (pollution:addValue({12, 34}, {{2018,4,1}, {0,0,0}}, temp, 10,
        pollution:addStation("Qwerty", {12, 34},
        pollution:createMonitor())))).
addValue4_test() -> 2 =
  length(dict:fetch({station, "Qwerty", {12, 34}},
    ...
    pollution:removeValue("Qwerty", {{2018,4,1}, {0,0,0}}, "PM10",
      (pollution:addValue("Qwerty", {{2018,4,1}, {0,0,0}}, "PM10", 59,
        (pollution:addValue({12, 34}, {{2018,4,1}, {0,0,0}}, temp, 10,
          pollution:addStation("Qwerty", {12, 34},
            pollution:createMonitor())))))))).
removeValue2_test() -> no_such_measurement =
    pollution:removeValue("Qwerty", {{2018,4,2}, {0,0,0}}, "PM10",
      (pollution:addValue("Qwerty", {{2018,4,1}, {0,0,0}}, "PM10", 59,
        (pollution:addValue({12, 34}, {{2018,4,1}, {0,0,0}}, temp, 10,
          pollution:addStation("Qwerty", {12, 34},
            pollution:createMonitor())))))).
removeValue3_test() -> no_such_station =
