...
%% API
createMonitor_test() -> code:add_path("/media/sem4/Erlang/laby/lab2/src"), true = (pollution_server:start()).
createMonitor2_test() -> [] = dict:fetch_keys(pollution_server:getMonitor()).
addStation1_test() ->
  pollution_server:addStation("Qwerty", {12, 34}),
  [{station, "Qwerty", {12, 34}}] = dict:fetch_keys(pollution_server:getMonitor()).
addStation2_test() ->
  pollution_server:addStation("Qwerty", {12, 12}),
  [{station, "Qwerty", {12, 34}}] = dict:fetch_keys(pollution_server:getMonitor()).
addStation3_test() ->
  pollution_server:addStation("Qwert", {12, 34}),
  [{station, "Qwerty", {12, 34}}] = dict:fetch_keys(pollution_server:getMonitor()).
addStation4_test() ->
  pollution_server:addStation("Asdf", {56,78}),
  [{station, "Qwerty", {12, 34}}, {station, "Asdf", {56,78}}] = dict:fetch_keys(pollution_server:getMonitor()).
addValue1_test() ->
  pollution_server:addValue("Qwerty", {{2018,4,1}, {0,0,0}}, temp, 10),
  [{measurement, {{2018,4,1},{0,0,0}}, temp, 10}] = dict:fetch({station, "Qwerty", {12, 34}}, pollution_server:getMonitor()).
addValue2_test() ->
  pollution_server:addValue({12, 34}, {{2018,4,1}, {0,0,0}}, temp, 10),
  [{measurement, {{2018,4,1},{0,0,0}}, temp, 10}] = dict:fetch({station, "Qwerty", {12, 34}}, pollution_server:getMonitor()).
addValue3_test() ->
  pollution_server:addValue("Qwerty", {{2018,4,1}, {0,0,0}}, temp, 20),
  1 = length(dict:fetch({station, "Qwerty", {12, 34}}, pollution_server:getMonitor())).
addValue4_test() ->
  pollution_server:addValue("Qwerty", {{2018,4,2}, {0,0,0}}, temp, 20),
  2 = length(dict:fetch({station, "Qwerty", {12, 34}}, pollution_server:getMonitor())).
addValue5_test() ->
  pollution_server:addValue("Qwerty", {{2018,4,1}, {12,0,0}}, temp, 20),
  3 = length(dict:fetch({station, "Qwerty", {12, 34}}, pollution_server:getMonitor())).
addValue6_test() ->
  pollution_server:addValue("Qwerty", {{2018,4,1}, {0,0,0}}, "PM10", 59),
  4 = length(dict:fetch({station, "Qwerty", {12, 34}}, pollution_server:getMonitor())).
addValue7_test() ->
  pollution_server:addValue({12, 34}, {{2018,4,1}, {0,0,0}}, "PM10", 59),
  4 = length(dict:fetch({station, "Qwerty", {12, 34}}, pollution_server:getMonitor())).
removeValue1_test() ->
  pollution_server:removeValue("Qwerty", {{2018,4,1}, {12,0,0}}, temp),
  3 = length(dict:fetch({station, "Qwerty", {12, 34}}, pollution_server:getMonitor())).
removeValue2_test() ->
  pollution_server:removeValue("Qwerty", {{2018,4,1}, {12,0,0}}, temp),
  3 = length(dict:fetch({station, "Qwerty", {12, 34}}, pollution_server:getMonitor())).
removeValue3_test() ->
  pollution_server:removeValue("Asdfgh", {{2018,4,1}, {0,0,0}}, "PM10"),
  3 = length(dict:fetch({station, "Qwerty", {12, 34}}, pollution_server:getMonitor())).
getOneValue1_test() ->
...
getStationMean3_test() ->
  pollution_server:addValue({12, 34}, {{2018,4,2}, {0,0,0}}, "PM10", 39),
...
getDailyMean1_test() ->
  pollution_server:addValue({12, 34}, {{2018,4,2}, {12,12,12}}, "PM10", 59),
...
getDeviation2_test() ->
  pollution_server:addValue("Asdf", {{2018,4,2}, {0,0,0}}, "PM11", 59),
  pollution_server:addValue({56,78}, {{2018,4,1}, {1,0,0}}, "PM11", 39),
  pollution_server:addValue({12,34}, {{2018,4,1}, {1,0,0}}, "PM11", 39),
  pollution_server:addValue("Qwerty", {{2018,4,2}, {0,0,0}}, "PM11", 59),
